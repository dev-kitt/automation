...
// SQL - FROM FILE
// executes sql statement to refresh database test data (DELETE & UPDATE)
function sqlRefreshDatabase(dbName) {
  Project.Variables.varDbName = dbName;
  var AConnection, recSet;
  var query = aqFile.ReadWholeTextFile(Project.Path + "\\Stores\\Files\\refresh_" + Project.Variables.varDbName + ".sql", aqFile.ctANSI);
